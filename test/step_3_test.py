...
# is is an expension, testing the proper generation in differnt settings. Thus only the Clutter Loss is tested,
# as well as the Sahdow Fading, as it is generated from a distribution
"""
...
# For more instight, see 3GPP Table 6.6.2-2: Shadow fading and clutter loss for urban scenario
    def test_s_band_10_degrees_dl(self):
        ...
        #Standardddeviation is CL std, as CL is a single value
