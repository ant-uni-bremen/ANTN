...
#TODO A future version will support the indoor states
...
def compute_pathloss_gas(self):
        ...
        # TODO In eager execution this code requires Yo to always be set. This the best solut would be to throw an exception if illeagal frequencies are encoutered. However, this
        # currently breaks eager execution and uses this value instead.A future version will properly cath this case and throw an exceotion.
        else:
            Yo = 0.0
